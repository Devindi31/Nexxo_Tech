...
<head>
    ...
    <title>Access Denied - Nexxo Tech</title>
    ...
    <div class="container-fluid animate__animated animate__fadeIn bg-light">
        <div class="row d-flex justify-content-center align-items-center vh-100">
            ...
            <div class="col-12 text-center">
                ...
                <img src="images/icon/Block.png" class="col-8 col-md-4 col-lg-2" alt="">
                <h4 class="fw-bold text-secondary mt-5">Your account has been blocked.</h4>
