...
<head>
    ...
    <title>Manage Order - Nexxo Tech</title>
</head>

<body onload="load_manage_order();">
                        ...
                        <div class="col-12">
                            <div class="row justify-content-around">
                                ...
                                <div class="col-12 row justify-content-center fixed-top" style="backdrop-filter: blur(15px);">
                                    <h1 class="fw-bold text-black text-center mt-4 mb-4">Manage Order</h1>
                                    ...
                                    <div class="col-11 col-lg-10">
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control bg-transparent" id="admin-product-name" placeholder="Search by product name or customer name . . ." style="border-top-left-radius: 25px;border-bottom-left-radius: 25px;">
                                            <button class="btn btn-dark" type="button" style="border-top-right-radius: 25px;border-bottom-right-radius: 25px;" onclick="search_admin_order();"><i class="bi bi-search"></i></button>
                                        </div>
                                    </div>
                                </div>


                                <div class="col-12 mb-5" style="margin-top: 160px;">
                                    <div class="row justify-content-center" id="admin-order-section">
