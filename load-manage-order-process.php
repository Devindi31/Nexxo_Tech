            ...
            <div class="p-panel p-is-active">
                ...
                <div class="col-12 mb-3">
                    <div class="row justify-content-center gap-4">
                        ...
                        INNER JOIN `product_image` ON `product_image`.`product_product_id`=`product`.`product_id` WHERE `status`!='5'");
                        ...
                        ?>
                                ...
                                <div class="rounded-4 animate__animated animate__fadeIn" style="width: 30rem; min-height: 300px;background-color: rgba(243, 243, 243, 0.71);">

                                    <div class="rounded-4 mt-3">
                                        <label class="text-secondary mt-2 float-end me-2" style="font-size: 14px;" for=""><b>Date : <?php echo $formatedDate_1; ?></b></label><br>
                            ...
                            <div class="col-12">
                                <div class="row justify-content-center">
                                    <div class="col-12  text-center mb-2 mt-4">
                                        ...
                                        <h4 class="text-secondary fw-bold mt-3">No incomplete orders are available at the moment.</h4>
                                    </div>
                                </div>
                            </div>
                        ...
                        ?>
                            ...
                            <div class="col-12 animate__animated animate__fadeIn">
                                <div class="row justify-content-center">
                                    <div class="col-12  text-center mb-2 mt-4">
                                        <img src="images/icon/Empty-Order.png" class="col-8 col-md-4 col-lg-1" alt="">
                                        <h4 class="text-secondary fw-bold mt-3">No complete orders are available at the moment.</h4>
